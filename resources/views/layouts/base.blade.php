...
<body>
	...
	<div id="menu" onclick="activate(!state);">
		<!-- Обязательное условие  меню должно  вкладывать  в себя модальное окно, в нашем случае modal_box для того чтобы его запустить -->
...
<polygon points="31.112,1.414 29.698,0 15.556,14.142 1.414,0 0,1.414 14.142,15.556 0,29.698 1.414,31.112 15.556,16.97 
	...
	<div id="modal_popup">
			...
			<!-- black_fill фон с темной подложкой -->
